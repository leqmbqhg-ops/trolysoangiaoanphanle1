...
<div class="main-header">
    ...
    <p>Tác giả: Phan Hồng Lễ - Trường PTDTBT Tiểu học Thắng Mố - ĐT: 0983 743 651</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phan Hồng Lễ - Trường PTDTBT Tiểu học Thắng Mố - ĐT: 0983 743 651</div>", unsafe_allow_html=True)
